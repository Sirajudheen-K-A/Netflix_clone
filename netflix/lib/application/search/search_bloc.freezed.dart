...
mixin _$SearchState {
  ...
  bool get isLoadiing => throw _privateConstructorUsedError;
...
class _$SearchStateImpl implements _SearchState {
  ...
  @override
  String toString() {
    return 'SearchState(searchResultList: $searchResultList, idealList: $idealList, isLoadiing: $isLoadiing, isError: $isError)';
  }
...
abstract class _SearchState implements SearchState {
  const factory _SearchState(
      {required final List<SearchResultData> searchResultList,
      required final List<Downloads> idealList,
      required final bool isLoadiing,
